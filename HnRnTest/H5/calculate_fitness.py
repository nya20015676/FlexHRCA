...
path_list = ["/home/amtc/Desktop/optimal/HnRnTest/H5/H5R1/",
             "/home/amtc/Desktop/optimal/HnRnTest/H5/H5R2/",
             "/home/amtc/Desktop/optimal/HnRnTest/H5/H5R3/",
             "/home/amtc/Desktop/optimal/HnRnTest/H5/H5R4/",
             "/home/amtc/Desktop/optimal/HnRnTest/H5/H5R5/",]
...
for j, Time in enumerate(Time_list):
    ...
    station_SVTNN.set_operator_product_Time([human1, human2, human3, human4, human5], robots_list[j], [product1, product2, product3], [Time, Time, Time])
    ...
    for mem_CHS_file in os.listdir(path_list[j]):
        if "pickle" in mem_CHS_file:
            with open(path_list[j]+mem_CHS_file, 'rb') as file: 
                ...
                chs = CHSs_list[0]
            fitness_list.append(station_SVTNN.calculate_fitness(chs[0], chs[1]))
    fitness = min(fitness_list)
    value = SVTNN.calculate_quantity_value(fitness, fitness.weight)
    ambiguity = SVTNN.calculate_ambiguity(fitness, fitness.weight)
    print("{}, value ambiguity = {:.2f} {:.2f}".format(fitness, value, ambiguity))
