...
path_list = ["/home/amtc/Desktop/optimal/comparison/CSP/H4/H4R1/",
...
for i in [6,7,8,9,10]:
    for j, Time in enumerate(Time_list):
        ...
        station_CSP.set_operator_product_Time([human1, human2, human3, human4], robots_list[j], [product1, product2, product3], [Time, Time, Time])
