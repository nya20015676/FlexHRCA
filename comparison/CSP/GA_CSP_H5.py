...
for i in [6,7,8,9,10]:
    for j, Time in enumerate(Time_list):
        ...
        station_CSP.set_operator_product_Time([human1, human2, human3, human4, human5], robots_list[j], [product1, product2, product3], [Time, Time, Time])
        
        if __name__ == '__main__':
            optimal_fitness, mem_SVTNN_CHS_list, mem_SVTNN_CHS_fitness_list,  record_list = station_CSP.GA(pop_size=300, p_crossover=0.9, p_cross_machine=0.67, p_mutation=0.1, p_mutation_machine=0.83, max_iteration=2000, tSize=4)
