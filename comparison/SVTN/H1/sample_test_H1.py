...
def calculate_fitness(file_name, n_robots):
    ...
    if n_robots == 1:
        station_SVTN.set_operator_product_Time([human1], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H1R1, TIME_TABLE.Time_H1R1,TIME_TABLE.Time_H1R1])
    if n_robots == 2:
        station_SVTN.set_operator_product_Time([human1], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H1R2, TIME_TABLE.Time_H1R2,TIME_TABLE.Time_H1R2])
    if n_robots == 3:
        station_SVTN.set_operator_product_Time([human1], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H1R3, TIME_TABLE.Time_H1R3,TIME_TABLE.Time_H1R3])
    if n_robots == 4:
        station_SVTN.set_operator_product_Time([human1], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H1R4, TIME_TABLE.Time_H1R4,TIME_TABLE.Time_H1R4])
    if n_robots == 5:
        station_SVTN.set_operator_product_Time([human1], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H1R5, TIME_TABLE.Time_H1R5,TIME_TABLE.Time_H1R5])
...
path_list = ["/home/amtc/Desktop/optimal/comparison/SVTN/H1/H1R1/",
