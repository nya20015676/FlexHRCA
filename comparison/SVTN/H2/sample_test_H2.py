...
def calculate_fitness(file_name, n_robots):
    ...
    if n_robots == 1:
        station_SVTN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H2R1, TIME_TABLE.Time_H2R1,TIME_TABLE.Time_H2R1])
    if n_robots == 2:
        station_SVTN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H2R2, TIME_TABLE.Time_H2R2,TIME_TABLE.Time_H2R2])
    if n_robots == 3:
        station_SVTN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H2R3, TIME_TABLE.Time_H2R3,TIME_TABLE.Time_H2R3])
    if n_robots == 4:
        station_SVTN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H2R4, TIME_TABLE.Time_H2R4,TIME_TABLE.Time_H2R4])
    if n_robots == 5:
        station_SVTN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE.Time_H2R5, TIME_TABLE.Time_H2R5,TIME_TABLE.Time_H2R5])
...
path_list = ["/home/amtc/Desktop/optimal/comparison/SVTN/H2/H2R1/",
