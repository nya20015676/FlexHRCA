...
from fuzzyNumber import FuzzyNumber, Triangular, SVTNN
...
for i in [1,2,3,4,5]:
    for j, Time in enumerate(Time_list):
        ...
        station_TFN.set_operator_product_Time([human1, human2], robots_list[j], [product1, product2, product3], [Time, Time, Time])
        
        if __name__ == '__main__':
            optimal_fitness, mem_SVTNN_CHS_list, mem_SVTNN_CHS_fitness_list,  record_list = station_TFN.GA(pop_size=300, p_crossover=0.9, p_cross_machine=0.67, p_mutation=0.1, p_mutation_machine=0.83, max_iteration=1000, tSize=4)
