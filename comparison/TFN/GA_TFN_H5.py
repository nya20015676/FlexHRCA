...
Time_list = [TIME_TABLE.Time_H5R1, TIME_TABLE.Time_H5R2, TIME_TABLE.Time_H5R3, TIME_TABLE.Time_H5R4, TIME_TABLE.Time_H5R5]
...
for i in [6,7,8,9,10]:
    for j, Time in enumerate(Time_list):
        ...
        if __name__ == '__main__':
            optimal_fitness, mem_SVTNN_CHS_list, mem_SVTNN_CHS_fitness_list,  record_list = station_TFN.GA(pop_size=300, p_crossover=0.9, p_cross_machine=0.67, p_mutation=0.1, p_mutation_machine=0.83, max_iteration=2000, tSize=4)
