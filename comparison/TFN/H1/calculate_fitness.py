...
Time_list = [TIME_TABLE_FUZZY.Time_H1R1, TIME_TABLE_FUZZY.Time_H1R2, TIME_TABLE_FUZZY.Time_H1R3, TIME_TABLE_FUZZY.Time_H1R4, TIME_TABLE_FUZZY.Time_H1R5]
...
for j, Time in enumerate(Time_list):
    ...
    station_FUZZY = HrcStation()
    station_FUZZY.set_operator_product_Time([human1], robots_list[j], [product1, product2, product3], [Time, Time, Time])
    ...
    print("{}, value spread = {:.2f} {:.2f}".format(fitness, value, spread))
