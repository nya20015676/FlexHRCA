...
Time_list = [TIME_TABLE_FUZZY.Time_H2R1, TIME_TABLE_FUZZY.Time_H2R2, TIME_TABLE_FUZZY.Time_H2R3, TIME_TABLE_FUZZY.Time_H2R4, TIME_TABLE_FUZZY.Time_H2R5]
...
for j, Time in enumerate(Time_list):
    ...
    station_FUZZY.set_operator_product_Time([human1, human2], robots_list[j], [product1, product2, product3], [Time, Time, Time])
