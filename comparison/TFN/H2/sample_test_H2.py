...
for lst in TIME_TABLE.Time_H2R1:
      for i in range(len(lst)):
          if lst[i] != 9999:
              lst[i].sampling()
for lst in TIME_TABLE.Time_H2R2:
      for i in range(len(lst)):
          if lst[i] != 9999:
              lst[i].sampling()
for lst in TIME_TABLE.Time_H2R3:
      for i in range(len(lst)):
          if lst[i] != 9999:
              lst[i].sampling()
for lst in TIME_TABLE.Time_H2R4:
      for i in range(len(lst)):
          if lst[i] != 9999:
              lst[i].sampling()
for lst in TIME_TABLE.Time_H2R5:
      for i in range(len(lst)):
          if lst[i] != 9999:
              lst[i].sampling()
...
def test_one_CHS_one_cycle(CHS, n_robots):
    ...
    if n_robots == 1:
        station_static.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [randomTime_SVTNN2static(TIME_TABLE.Time_H2R1), randomTime_SVTNN2static(TIME_TABLE.Time_H2R1), randomTime_SVTNN2static(TIME_TABLE.Time_H2R1)])
    if n_robots == 2:
        station_static.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [randomTime_SVTNN2static(TIME_TABLE.Time_H2R2), randomTime_SVTNN2static(TIME_TABLE.Time_H2R2), randomTime_SVTNN2static(TIME_TABLE.Time_H2R2)])
    if n_robots == 3:
        station_static.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [randomTime_SVTNN2static(TIME_TABLE.Time_H2R3), randomTime_SVTNN2static(TIME_TABLE.Time_H2R3), randomTime_SVTNN2static(TIME_TABLE.Time_H2R3)])
    if n_robots == 4:
        station_static.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [randomTime_SVTNN2static(TIME_TABLE.Time_H2R4), randomTime_SVTNN2static(TIME_TABLE.Time_H2R4), randomTime_SVTNN2static(TIME_TABLE.Time_H2R4)])
    if n_robots == 5:
        station_static.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [randomTime_SVTNN2static(TIME_TABLE.Time_H2R5), randomTime_SVTNN2static(TIME_TABLE.Time_H2R5), randomTime_SVTNN2static(TIME_TABLE.Time_H2R5)])
...
def calculate_fitness(file_name, n_robots):
    ...
    if n_robots == 1:
        station_TFN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H2R1, TIME_TABLE_FUZZY.Time_H2R1,TIME_TABLE_FUZZY.Time_H2R1])
    if n_robots == 2:
        station_TFN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H2R2, TIME_TABLE_FUZZY.Time_H2R2,TIME_TABLE_FUZZY.Time_H2R2])
    if n_robots == 3:
        station_TFN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H2R3, TIME_TABLE_FUZZY.Time_H2R3,TIME_TABLE_FUZZY.Time_H2R3])
    if n_robots == 4:
        station_TFN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H2R4, TIME_TABLE_FUZZY.Time_H2R4,TIME_TABLE_FUZZY.Time_H2R4])
    if n_robots == 5:
        station_TFN.set_operator_product_Time([human1, human2], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H2R5, TIME_TABLE_FUZZY.Time_H2R5,TIME_TABLE_FUZZY.Time_H2R5])
...
path_list = ["/home/amtc/Desktop/optimal/comparison/TFN/H2/H2R1/",
