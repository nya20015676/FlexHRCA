...
Time_list = [TIME_TABLE_FUZZY.Time_H4R1, TIME_TABLE_FUZZY.Time_H4R2, TIME_TABLE_FUZZY.Time_H4R3, TIME_TABLE_FUZZY.Time_H4R4, TIME_TABLE_FUZZY.Time_H4R5]
...
for j, Time in enumerate(Time_list):
    ...
    station_FUZZY.set_operator_product_Time([human1, human2, human3, human4], robots_list[j], [product1, product2, product3], [Time, Time, Time])
