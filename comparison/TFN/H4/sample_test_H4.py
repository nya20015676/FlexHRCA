...
def calculate_fitness(file_name, n_robots):
    ...
    if n_robots == 1:
        station_TFN.set_operator_product_Time([human1, human2, human3, human4], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H4R1, TIME_TABLE_FUZZY.Time_H4R1,TIME_TABLE_FUZZY.Time_H4R1])
    if n_robots == 2:
        station_TFN.set_operator_product_Time([human1, human2, human3, human4], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H4R2, TIME_TABLE_FUZZY.Time_H4R2,TIME_TABLE_FUZZY.Time_H4R2])
    if n_robots == 3:
        station_TFN.set_operator_product_Time([human1, human2, human3, human4], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H4R3, TIME_TABLE_FUZZY.Time_H4R3,TIME_TABLE_FUZZY.Time_H4R3])
    if n_robots == 4:
        station_TFN.set_operator_product_Time([human1, human2, human3, human4], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H4R4, TIME_TABLE_FUZZY.Time_H4R4,TIME_TABLE_FUZZY.Time_H4R4])
    if n_robots == 5:
        station_TFN.set_operator_product_Time([human1, human2, human3, human4], robots_list[n_robots-1], [product1, product2, product3], [TIME_TABLE_FUZZY.Time_H4R5, TIME_TABLE_FUZZY.Time_H4R5,TIME_TABLE_FUZZY.Time_H4R5])
...
path_list = ["/home/amtc/Desktop/optimal/comparison/TFN/H4/H4R1/",
