...
Time_list = [TIME_TABLE_FUZZY.Time_H5R1, TIME_TABLE_FUZZY.Time_H5R2, TIME_TABLE_FUZZY.Time_H5R3, TIME_TABLE_FUZZY.Time_H5R4, TIME_TABLE_FUZZY.Time_H5R5]
...
for j, Time in enumerate(Time_list):
    ...
    station_FUZZY.set_operator_product_Time([human1, human2, human3, human4, human5], robots_list[j], [product1, product2, product3], [Time, Time, Time])
