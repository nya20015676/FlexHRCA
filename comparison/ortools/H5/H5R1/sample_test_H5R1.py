...
sys.path.append('../../..')  # 将上一级目录添加到Python的模块搜索路径中
sys.path.append('../../../..')  # 将上一级目录添加到Python的模块搜索路径中
sys.path.append('../../../../HnRnTest')  # 将上一级目录添加到Python的模块搜索路径中
...
def test_CHSs(filename, n_robots):
    ...
    if os.path.exists(excel_name):
        send2trash.send2trash(excel_name)  # 如果文件存在，先删除它
    wb.save(excel_name)
...
path_list = ["/home/amtc/Desktop/optimal/comparison/ortools/H5/H5R1/",
