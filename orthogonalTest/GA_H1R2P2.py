...
station_static.set_operator_product_Time([human1], [robot1, robot2], [product1, product2], [transTime_SVTNN2static(Time_H1R2), transTime_SVTNN2static(Time_H1R2)])
station_fuzzy.set_operator_product_Time([human1], [robot1, robot2], [product4, product5], [transTime_SVTNN2fuzzy(Time_H1R2), transTime_SVTNN2fuzzy(Time_H1R2)])
station_SVTNN.set_operator_product_Time([human1], [robot1, robot2], [product7, product8], [Time_H1R2, Time_H1R2])
...
path = "/home/amtc/Desktop/optimal/orthogonalTest/results/H1R2P2/" # 文件保存路径
