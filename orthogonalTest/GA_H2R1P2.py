...
station_static.set_operator_product_Time([human1, human2], [robot1], [product1, product2], [transTime_SVTNN2static(Time_H2R1), transTime_SVTNN2static(Time_H2R1)])
station_fuzzy.set_operator_product_Time([human1, human2], [robot1], [product4, product5], [transTime_SVTNN2fuzzy(Time_H2R1), transTime_SVTNN2fuzzy(Time_H2R1)])
station_SVTNN.set_operator_product_Time([human1, human2], [robot1], [product7, product8], [Time_H2R1, Time_H2R1])
...
path = "/home/amtc/Desktop/optimal/orthogonalTest/results/H2R1P2/" # 文件保存路径
