...
station_SVTNN.set_operator_product_Time([human1, human2], [robot1, robot2, robot3], [product7, product8, product9], [Time_H2R3, Time_H2R3, Time_H2R3])
...
path = "/home/amtc/Desktop/optimal/orthogonalTest/results/H2R3P3/" # 文件保存路径
