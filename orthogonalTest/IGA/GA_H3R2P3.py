...
station_SVTNN.set_operator_product_Time([human1, human2, human3], [robot1, robot2], [product7, product8, product9], [Time_H3R2, Time_H3R2, Time_H3R2])
...
path = "/home/amtc/Desktop/optimal/orthogonalTest/results/H3R2P3/" # 文件保存路径
