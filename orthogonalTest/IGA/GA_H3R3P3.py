...
station_static.set_operator_product_Time([human1, human2, human3], [robot1, robot2, robot3], [product1, product2, product3], [transTime_SVTNN2static(Time_H3R3), transTime_SVTNN2static(Time_H3R3), transTime_SVTNN2static(Time_H3R3)])
station_fuzzy.set_operator_product_Time([human1, human2, human3], [robot1, robot2, robot3], [product4, product5, product6], [transTime_SVTNN2fuzzy(Time_H3R3), transTime_SVTNN2fuzzy(Time_H3R3), transTime_SVTNN2fuzzy(Time_H3R3)])
station_SVTNN.set_operator_product_Time([human1, human2, human3], [robot1, robot2, robot3], [product7, product8, product9], [Time_H3R3, Time_H3R3, Time_H3R3])
...
path = "/home/amtc/Desktop/optimal/orthogonalTest/results/H3R3P3/" # 文件保存路径
